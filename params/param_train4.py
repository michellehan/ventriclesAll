...
parameters = {
    ...
    "test-csv"          : "/data/NormalVentricle/normalHydro/labels/t2_test.csv",
    #"test-csv"          : "/data/NormalVentricle/normalHydro/labels/t2_all.csv",
   ...
   # "arch"              : "DynamicUnet",
    ...
    "num-classes"       : 2,
    "lr"                : 0.05,
    "lr-decay"          : 15,                       # lr *= 0.25 every n epochs
    "momentum"          : 0.9,
    "weight-decay"      : 0.0001,
    "ema-decay"         : 0.999,
    ...
    "print-freq"        : 200,                 # console print progress for every n batches
